...
export default function SignUp() {
  ...
  const postData = () => {
    ...
    if (!emailRegex.test(email)) {
      ...
      notifyA(
        "The password string must be 8 characters or longer including at least 1 lowercase alphabetical character, uppercase alphabetical character, numeric character and special character."
      );
      return;
    }
